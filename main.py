...
from data_loader_copy import load_and_cache_examples
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default='new_data', required=True, type=str, help="The name of the task to train")
    parser.add_argument("--model_dir", default='./practice_model', required=True, type=str, help="Path to save, load model")
